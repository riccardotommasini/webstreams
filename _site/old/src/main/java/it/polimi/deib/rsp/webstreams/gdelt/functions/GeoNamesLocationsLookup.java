...
public class GeoNamesLocationsLookup {
    ...
    public String lookup(@FnoParam("http://example.org/toLookup") String locationsToLookup) throws IOException {
        ...
        for (String location : locations) {
            ...
            try {
                String query = "name_equals=" + name + "&country=" + countryCode + "&maxRows=" + max_rows + "&type=rdf&fuzzy=" + fuzziness + "&username=" + username;
